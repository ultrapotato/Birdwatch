  ...
  return [
    {
      ...
      imageUrl: "/homepage_images/scarlet_tanager_0.avif?height=300&width=400&query=scarlet tanager",
    ...
    },
    {
      ...
      imageUrl: "/homepage_images/summer_tanager_0.avif?height=300&width=400&query=summer tanager",
      tags: ["red", "songbird", "migratory"],
      createdAt: new Date(Date.now() - 345600000).toISOString(),
    ...
    },
    {
      ...
      imageUrl: "/homepage_images/pyrrhuloxia_0.avif?height=300&width=400&query=pyrrhuloxia desert cardinal",
