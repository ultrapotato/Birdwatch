  ...
  import { CheckCircle2, TelescopeIcon as Binoculars, BookOpen, MapPin, Camera, Users, ArrowRight } from "lucide-react"
  import { useRouter } from "next/navigation"
  import { useState, useEffect } from "react"
  import { getCommonBirds } from "@/lib/frontend-api/birds"
  import type { BirdSpecies } from "@/lib/models/bird.models"

  export default function BeginnersGuidePage() {
    // Hardcoded steps for getting started
    const router = useRouter()
    const [commonBirds, setCommonBirds] = useState<Partial<BirdSpecies>[]>([])
    ...
    const steps = [
      {
        ...
        imageUrl:
          "https://plus.unsplash.com/premium_photo-1723737604431-38f248fc5473?q=80&w=2923&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?height=300&width=500&query=bird watching binoculars",
        tips: [
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1486365227551-f3f90034a57c?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?height=300&width=500&query=bird identification guide",
        tips: [
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1519331379826-f10be5486c6f?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?height=300&width=500&query=birding location park",
        tips: [
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1452421822248-d4c2b47f0c81?q=80&w=3174&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?height=300&width=500&query=birdwatcher taking notes",
        tips: [
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?height=300&width=500&query=bird watching group",
        tips: [
        ...
        items: [
          {
            ...
            beginner: true,
            imageUrl:
              "https://images.cdn.us-central1.gcp.commercetools.com/f7c8f2bb-aff1-4581-a826-1ad2527be222/Back-M5_8x42_rear_le-Qv5_JPih-large.png?height=100&width=100&query=Nikon Monarch binoculars",
          },
          {
            ...
            beginner: true,
            imageUrl:
              "https://vortexoptics.com/media/catalog/product/v/t/vtx_bin_diamondback2_42_f_w_1.jpg?quality=80&bg-color=255,255,255&fit=bounds&height=338&width=578&canvas=578:338&dpr=2%202x?height=100&width=100&query=Vortex Diamondback binoculars",
          },
          {
            ...
            beginner: true,
            imageUrl:
              "https://www.celestron.com/cdn/shop/products/71332_nature_dx_8x42_1-R_570x380@2x.jpg?v=1654808560?height=100&width=100&query=Celestron Nature binoculars",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            beginner: true,
            imageUrl:
              "https://www.sibleyguides.com/wp-content/uploads/newBirdcover3.gif?height=100&width=100&query=Sibley Guide to Birds",
          },
          {
            ...
            beginner: true,
            imageUrl:
              "https://images.natgeomaps.com/PROD_LG_1000px/BK26218354_0_LG.jpg?height=100&width=100&query=National Geographic Bird Guide",
          },
          {
            ...
            beginner: true,
            imageUrl:
              "https://m.media-amazon.com/images/I/51CJviNaOsL._SX342_SY445_.jpg?height=100&width=100&query=Peterson Bird Guide",
          },
        ],
      },
      {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {commonBirds.map((bird) => (
                    <div key={bird.id} className="border rounded-lg overflow-hidden">
                      <img
                        src={bird.defaultImageUrl || "/placeholder.svg"}
                        alt={bird.speciesName}
                        className="w-full aspect-square object-cover"
                      />
                      <div className="p-4">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="font-bold">{bird.speciesName}</h3>
                        </div>
